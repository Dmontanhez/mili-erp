...
# =======================================================================
# NOVA SIMULAÇÃO: COMPRA REAL DO MERCADO LIVRE (orders_v2)
# =======================================================================
def simulate_meli_order() -> None:
    order_id = random.randint(2000000000, 2999999999)
    seller_id = 123456  # ID Simulado do Vendedor ML

    # O seu main.py extrai os dados de dentro do corpo do JSON (MeliWebhookPayload)
    data = {
    ...
    # Envia o webhook estruturado corretamente para a rota /webhooks/meli
    send_meli_webhook("orders_v2", f"/orders/{order_id}", data)
...
def main() -> None:
    ...
    simulate_meli_order()  # <-- Executa a nova simulação de compra real do ML
    time.sleep(0.2)
